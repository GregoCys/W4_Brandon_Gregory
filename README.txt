...
//                                                                                     //
// 2. Double-click on the file named 'W4_Brandon_Gregory.exe' to run it.               //
//                                                                                     //
//    Alternatively, you can also run it from the terminal by navigating to its        //
//    location and typing ./W4_Brandon_Gregory.exe (if you're on a Unix-like system) or//
//    W4_Brandon_Gregory.exe (if you're on Windows) and hitting Enter.                 //
//                                                                                     //
// 3. A terminal window will open, and you'll be prompted to enter your name.          //
//    Type your name and press Enter.                                                  //
//                                                                                     //
// 4. Once you have entered your name, a menu will appear with various options,        //
...
//    calculations. Follow the prompts and press Enter.                                //
//                                                                                     //
// 7. The program will display the result of the selected action or save it for later  //
//    viewing.                                                                         //
//                                                                                     //
// 8. The menu will reappear, allowing you to perform additional actions or view       //
//    saved calculations.                                                              //
//                                                                                     //
